...
from UUBlog.apps.accounts.views import baseaccountsview, viewaccounts,viewajax
...
urlpatterns += patterns('',
    url(r'^accountsajax/checkdata/$', viewajax.checkdata, name='accountsajaxcheckdata'),
