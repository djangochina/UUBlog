...
#class DicCategory(UBaseModel):
#    ename=models.CharField(max_length=80)
#    cname=models.CharField(max_length=80)
#    cn1=models.CharField(max_length=80)
#    cn2=models.CharField(max_length=80)
#    cn3=models.CharField(max_length=80)
#    ename=models.CharField(max_length=80)

#class DicInfo(UBaseModel):
#    ename=models.CharField(max_length=80)
#    cname=models.CharField(max_length=80)
#    cn1=models.CharField(max_length=80)
#    cn2=models.CharField(max_length=80)
...
#    valuetype=models.CharField(max_length=80)
#    sortnum=models.IntegerField(default=10)
#    isenable=models.IntegerField(default=10)
